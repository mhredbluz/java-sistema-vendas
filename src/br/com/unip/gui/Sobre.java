...
public class Sobre extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lbIcone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/unip/gui/img/sobre.png"))); // NOI18N
        ...
        taTexto.setRows(5);
        taTexto.setText("Sistema de Vendas\nAutor: Marcos Henrique Soares Dutra\nE-mail: mhredbluz@gmail.com\n\nAplicação desenvolvida como material de\napoio ao aprendizado de programação \nJava usando o pacote Swing. É fornecida\n gratuitamente \"no estado em que se \nencontra\", isentando o autor de qualquer\n garantia ou danos que possam resultar \ndo uso da mesma.");
